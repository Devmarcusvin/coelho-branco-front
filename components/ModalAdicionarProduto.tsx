  ...
  return (
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50">
      <div style={{ backgroundColor: "#EDEDED" }} className="rounded-2xl p-6 w-full max-w-md relative">
        ...
        <h2 className="text-center font-black text-2xl mb-4">Adicionar Produto</h2>
        ...
        <div className="flex items-center justify-center gap-6 mb-4">
          <button
            ...
            className="w-8 h-8 rounded-full border border-[#6A38F3] text-[#6A38F3] flex items-center justify-center"
          >
            <Minus className="size-4" />
          </button>
          <span className="text-xl font-bold text-[#6A38F3]">{quantidade}</span>
          <button
